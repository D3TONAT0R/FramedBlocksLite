...
import xfacthd.framedblockslite.api.datagen.models.AbstractFramedBlockModelProvider;
import xfacthd.framedblockslite.api.model.item.tint.FramedBlockItemTintProvider;
import xfacthd.framedblockslite.api.util.ClientUtils;
import xfacthd.framedblockslite.api.util.FramedConstants;
import xfacthd.framedblockslite.api.util.Utils;
import xfacthd.framedblockslite.client.model.item.FramedBlockItemModel;
import xfacthd.framedblockslite.client.model.item.modelprovider.FenceBlockItemModelProvider;
import xfacthd.framedblockslite.client.model.loader.fallback.FallbackLoaderBuilder;
import xfacthd.framedblockslite.client.model.geometry.cube.FramedMarkedCubeGeometry;
...
import xfacthd.framedblockslite.common.data.property.ChainType;
...
public final class FramedBlockModelProvider extends AbstractFramedBlockModelProvider
{
    ...
    private void registerFramedChiseledBookshelf(BlockModelGenerators blockModels)
    {
        ...
        ModelTemplate[] bookSlotTemplates = Arrays.stream(bookSlots)
                .map(slot -> ModelTemplates.create("framedblockslite:template_framed_chiseled_bookshelf_slot_" + slot, TextureSlot.TEXTURE))
