...
import xfacthd.framedblockslite.client.screen.overlay.*;
import xfacthd.framedblockslite.client.screen.overlay.*;
import xfacthd.framedblockslite.common.compat.atlasviewer.AtlasViewerCompat;
import xfacthd.framedblockslite.common.compat.jade.JadeCompat;
import xfacthd.framedblockslite.common.compat.jei.JeiConstants;
...
public final class FramedLanguageProvider extends LanguageProvider
{
    ...
    {
        add("framedblockslite.configuration.general", "General");
        add("framedblockslite.configuration.powered_framing_saw", "Powered Framing Saw");
        ...
        //add("framedblockslite.configuration.general", "General");
        add("framedblockslite.configuration.overlay", "Overlays");
        ...
        add("framedblockslite.configuration.section.framedblockslite.devtools.toml", "Dev Tools Settings");
        add("framedblockslite.configuration.section.framedblockslite.devtools.toml.title", "FramedBlocks Dev Tools Configuration");
